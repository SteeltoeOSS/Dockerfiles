...
SteeltoeOSS https://cloud.spring.io/spring-cloud-config/[Spring Cloud Config Server, window="_blank"] docker image.

== Running

By default, the server listens on port 8888 and gets it configuration from https://github.com/spring-cloud-samples/config-repo[window="_blank"].
